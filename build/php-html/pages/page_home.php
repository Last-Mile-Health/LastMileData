...
<html>
    ...
    <head>
        ...
        <link rel="stylesheet" href="/LastMileData/build/css/page_home.min.css">
        
        <script src="/LastMileData/build/js/page_home.min.js"></script>
        ...
        <div class="container main">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <p><a class="fadeLink btn btn-success" href="/LastMileData/src/php-html/pages/page_dataportal.php">Go to Data Portal &raquo;</a></p>
                </div>
                <div class="col-md-4">
                    <h2>M&E Documents</h2>
                    ...
                    <p><a href="/LastMileData/src/php-html/pages/page_medocs.php" class="btn btn-success">Go to M&E Documents &raquo;</a></p>
                </div>
                <div class="col-md-4">
                    <h2>Data Entry / QA</h2>
                    <p>This section of the site is used by our M&E staff, and can be accessed offline when no internet connection is present.</p>
                    <p><a href="/LastMileData/src/php-html/pages/page_deqa.html" class="btn btn-success">Go to Data Entry / QA &raquo;</a></p>
                </div>
            </div>
            <hr>
            <div class="row">
