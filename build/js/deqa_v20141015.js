...
$(document).ready(function(){
    ...
    $('#qa_KPI_02').click(function() {
        launchQAModal({
            targetForm: "/LastMileData/src/forms/old/fhw_kpi02_kpiassessment.html",
    ...
    $('#qa_EES_02').click(function() {
        launchQAModal({
            targetForm: "/LastMileData/src/forms/old/fhw_ees02_ebolaeducationscreening.html",
    ...
    $('#qa_TRL_01').click(function() {
        launchQAModal({
            targetForm: "/LastMileData/src/forms/old/prg_trl01_trainingledger.html",
...
function ajaxRefresh() {
    ...
    $.ajax({
        url: "/LastMileData/src/php-html/scripts/refreshData.php",
