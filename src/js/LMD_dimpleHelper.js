...
//            if (params.overrideMax !== "") { x.overrideMax = new Date(params.overrideMax); }
        ...
        if (params.type==="line" || params.type==="bar") {
            ...
            if (params.type==="line") {
                ...
                var myArr = [{"Konobo":"#9BBB59"},{"Gboe-Ploe":"#C0504D"},{"Grand Bassa":"#C0504D"},{"Grand Gedeh":"#F79646"},{"Rivercess":"#4F81BD"},{"Rivercess c1":"#4BACC6"},{"Rivercess c2":"#8064A2"},{"Monrovia":"#202020"}];
                for (el in myArr) {
