var svg = dimple.newSvg("#dataportal_dashboard_numFacilitiesIPC", 475, 400);

// Data (!!!!! fill manually for now !!!!!)
var data = [
    { "Month":"Dec '14", "Measure":"Facilities", "Number":35, "Order":1 },
    { "Month":"Jan '15", "Measure":"Facilities", "Number":35, "Order":2 }
];
