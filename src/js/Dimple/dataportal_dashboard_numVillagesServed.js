var svg = dimple.newSvg("#dataportal_dashboard_numVillagesServed", 475, 400);

// Data (!!!!! fill manually for now !!!!!)
var data = [
    { "Month":"Dec '14", "Measure":"Villages", "Number":52, "Order":1 },
    { "Month":"Jan '15", "Measure":"Villages", "Number":52, "Order":2 }
];
