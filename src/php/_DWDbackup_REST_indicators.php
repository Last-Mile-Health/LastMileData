...
function addOne() {
	...
	$bodyDecode = json_decode($body);
        $indName = $bodyDecode->indName;
        $indCategory = $bodyDecode->indCategory;
        $indFormat = $bodyDecode->indFormat;
        $indDefinition = $bodyDecode->indDefinition;
        $indTarget = $bodyDecode->indTarget;
